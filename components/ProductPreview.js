...
export default function ProductPreview({productImage,sizes}){
    return(
        ...
        <div className="border-[1px] border-gray-700 w-60 flex justify-center h-fit">
            ...
            <div className="w-4/6 h-fit grid">
                <p className="font-bold text-2xl text-gray-700">Harvester</p>
                ...
                <p> madaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaame ya madaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaame ya madaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaame ya madaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaame ya madaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaame </p>
