...
export default function ProductPreview(props){
    return(
        <div className="w-11/12 xl:w-6/12 h-fit flex flex-wrap md:flex-nowrap justify-start sm:justify-evenly shadow-2xl px-3 py-10 rounded-lg animate__animated animate__slideInRight">
