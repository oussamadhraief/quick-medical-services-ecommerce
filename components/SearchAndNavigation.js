...
export default function SearchAndNavigation(){
    ...
    return (
        <div className="flex relative flex-wrap sm:flex-nowrap pr-3 bg-white border-[1px] h-fit sm:h-20 rounded-lg w-full">
            ...
            <input type="text" name="search" value="" className="sm:rounded-r-lg pt-3 sm:pt-0 border-l-0 sm:border-l border-t-[1px] sm:border-t-0 h-14 outline-none text-lg px-4 w-full" placeholder="Chercher un produit..."/>
