...
export default function SearchAndNavigation(){
    ...
    return (
        <div className="flex relative flex-wrap sm:flex-nowrap px-3 mx-5 py-3 bg-white border-[1px] h-fit sm:h-20 rounded-lg w-11/12 md:w-4/6 xl:w-full shadow-3xl">
            <CategoriesMenu />
