...
export default function PagesNavigator(props){
    ...
    return(
        <div className={props.relative ? "relative  h-fit w-fit mr-5 flex justify-center flex-nowrap py-1 bg-[rgba(255,255,255,0.9)] z-50 rounded-b-lg" : "absolute bottom-0 h-fit w-full flex justify-center flex-nowrap py-1 bg-[rgba(255,255,255,0.9)] z-50 rounded-b-lg"}>
