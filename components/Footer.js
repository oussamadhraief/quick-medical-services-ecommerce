...
export default function Footer(){
    ...
    return (
        <footer className="w-full h-[500px] grid bg-ciel rounded-tr-[70px] mt-32 shadow-3xl">
            <div className="h-fit py-5 px-14 w-[94%] flex justify-center gap-32 flex-nowrap items-center">
            ...
            <div className="w-[94%] min-h-full flex justify-around items-center h-[350px] pt-20 bg-third rounded-tr-[70px]">
