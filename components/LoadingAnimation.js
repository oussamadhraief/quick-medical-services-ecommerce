...
export default function LoadingAnimation(props){
    return (
        <div id="loadingAnimation" className={props.bgOpacity ? "absolute top-0 left-0 w-full h-full bg-white z-50 flex justify-center items-center" : "absolute top-0 left-0 w-full h-full bg-[rgba(255,255,255,0.7)] z-50 flex justify-center items-center"}>
