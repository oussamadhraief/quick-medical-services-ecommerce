...
export default function ScrollableProduct({product}){
    ...
    return (
        <div className="w-60 min-w-min p-3 relative animate__animated animate__fadeIn md:p-0 md:min-w-[320px] h-[390px] border-[1px] border-zinc-300 rounded-lg grid place-items-center mb-5 overflow-hidden">
            ...
            <div className="h-fit w-fit max-w-full overflow-hidden mx-auto px-1">
                ...
                <button className="bg-gradient-to-r from-cool to-na3ne3i rounded-lg text-white text-sm font-medium px-3 py-2 z-10 my-1 h-fit w-fit whitespace-nowrap" onClick={e => console.log('gg')}>Ajouter au panier</button>
