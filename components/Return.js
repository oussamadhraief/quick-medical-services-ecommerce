...
export default function ArchivedProducts(props){
    ...
    return (
        <div className={props.show ? "mt-9 w-fit pr-1 pl-0.5 flex flex-nowrap items-center space-x-1 hover:cursor-pointer group absolute bottom-3" : 'hidden' } onClick={() => {if(!loadingContext) window.location="/"}}>
