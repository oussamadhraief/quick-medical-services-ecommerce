...
export default function OrderForm(props){
    ...
    return(
        <form onSubmit={e => handleSubmit(e)} className='w-5/12 h-fit px-5 py-10 bg-white grid min-w-[340px]'>
                    ...
                    <button type="submit" className='mx-auto mt-10 w-fit h-fit bg-orange text-white whitespace-nowrap font-medium px-3 py-2 rounded-xl hover:bg-orange hover:text-black hover:scale-105 transition-all'>Confirmer ma demande</button>
