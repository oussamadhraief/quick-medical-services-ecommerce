...
export default function Notification(props){
    ...
    return (
        <div id="notification" className={appear.display ? "absolute block bottom-3 z-50 mx-auto left-0 right-0 w-fit h-fit px-5 py-3 bg-emerald-700 text-center font-normal text-medium text-white rounded-xl animate__animated animate__bounceInUp" : "absolute hidden"}>
