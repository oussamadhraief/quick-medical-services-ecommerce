...
<div>
      ...
      <form onSubmit={handleSubmit} className='w-full lg:w-10/12 mx-auto h-fit px-2 py-10 overflow-auto relative grid place-items-center lg:place-items-start gap-14 lg:p-10'>
